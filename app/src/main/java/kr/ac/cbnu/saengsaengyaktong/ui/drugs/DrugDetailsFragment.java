...
import kr.ac.cbnu.saengsaengyaktong.databinding.FragmentDrugDetailsBinding;
...
public class DrugDetailsFragment extends Fragment {
    ...
    private FragmentDrugDetailsBinding binding;

    private final String id;
    private DrugPermitInfo info;

    public DrugDetailsFragment(String id) {
        this.id = id;
    }

    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentDrugDetailsBinding.inflate(getLayoutInflater());
