...
public class surveyActivity7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        findViewById(R.id.O_btn).setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                is_O = true;
                Intent intent = new Intent(surveyActivity7.this, surveyActivity8.class);
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Intent intent = new Intent(surveyActivity7.this, surveyActivity6.class);
                startActivity(intent);
                Log.d("Vitamin_B",Integer.toString(health.getVitaminB()));
            }
        });
