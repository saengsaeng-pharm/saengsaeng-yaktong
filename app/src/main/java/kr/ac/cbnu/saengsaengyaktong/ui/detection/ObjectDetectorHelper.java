...
public class ObjectDetectorHelper {
    ...
    public void setupObjectDetector() {
        final ObjectDetector.ObjectDetectorOptions.Builder optionsBuilder = ObjectDetector.ObjectDetectorOptions.builder()
                .setScoreThreshold(threshold)
                .setMaxResults(maxResults);

        final BaseOptions.Builder baseOptionsBuilder = BaseOptions.builder().setNumThreads(numThreads);
    ...
    public void detect(Bitmap image, int imageRotation) {
        ...
        final TensorImage tensorImage = imageProcessor.process(TensorImage.fromBitmap(image));

        final List<Detection> results = objectDetector.detect(tensorImage);
